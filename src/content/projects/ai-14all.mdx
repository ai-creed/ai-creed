...
download: "https://github.com/ai-creed/ai-14all/releases/download/v0.10.2/ai-14all-0.10.2-arm64.dmg"
downloadWindows: "https://github.com/ai-creed/ai-14all/releases/download/v0.10.2/ai-14all-0.10.2-x64-Setup.exe"
install: |
...
- **macOS** (Apple Silicon) — [ai-14all-0.10.2-arm64.dmg](https://github.com/ai-creed/ai-14all/releases/download/v0.10.2/ai-14all-0.10.2-arm64.dmg) — signed + notarized; opens normally.
- **Windows** (x64) — [ai-14all-0.10.2-x64-Setup.exe](https://github.com/ai-creed/ai-14all/releases/download/v0.10.2/ai-14all-0.10.2-x64-Setup.exe) — unsigned; SmartScreen may warn on first run → **More info → Run anyway**.
