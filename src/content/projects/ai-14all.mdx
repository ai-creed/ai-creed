...
download: "https://github.com/ai-creed/ai-14all/releases/download/v0.7.3/ai-14all-0.7.3-arm64.dmg"
install: |
...
Latest stable release: **v0.7.3** — [ai-14all-0.7.3-arm64.dmg](https://github.com/ai-creed/ai-14all/releases/download/v0.7.3/ai-14all-0.7.3-arm64.dmg)
