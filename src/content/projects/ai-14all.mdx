...
download: "https://github.com/ai-creed/ai-14all/releases/download/v1.8.1/ai-14all-1.8.1-universal.dmg"
downloadWindows: "https://github.com/ai-creed/ai-14all/releases/download/v1.8.1/ai-14all-1.8.1-x64-Setup.exe"
install: |
...
- **macOS** (Universal — Intel + Apple Silicon) — [ai-14all-1.8.1-universal.dmg](https://github.com/ai-creed/ai-14all/releases/download/v1.8.1/ai-14all-1.8.1-universal.dmg) — signed + notarized; runs on any Mac.
- **macOS** (Apple Silicon, native) — [ai-14all-1.8.1-arm64.dmg](https://github.com/ai-creed/ai-14all/releases/download/v1.8.1/ai-14all-1.8.1-arm64.dmg) — slimmer native download for Apple Silicon.
- **Windows** (x64) — [ai-14all-1.8.1-x64-Setup.exe](https://github.com/ai-creed/ai-14all/releases/download/v1.8.1/ai-14all-1.8.1-x64-Setup.exe) — unsigned; SmartScreen may warn on first run → **More info → Run anyway**.
