...
download: "https://github.com/ai-creed/ai-14all/releases/download/v1.3.0/ai-14all-1.3.0-universal.dmg"
downloadWindows: "https://github.com/ai-creed/ai-14all/releases/download/v1.3.0/ai-14all-1.3.0-x64-Setup.exe"
install: |
...
- **macOS** (Universal — Intel + Apple Silicon) — [ai-14all-1.3.0-universal.dmg](https://github.com/ai-creed/ai-14all/releases/download/v1.3.0/ai-14all-1.3.0-universal.dmg) — signed + notarized; runs on any Mac.
- **macOS** (Apple Silicon, native) — [ai-14all-1.3.0-arm64.dmg](https://github.com/ai-creed/ai-14all/releases/download/v1.3.0/ai-14all-1.3.0-arm64.dmg) — slimmer native download for Apple Silicon.
- **Windows** (x64) — [ai-14all-1.3.0-x64-Setup.exe](https://github.com/ai-creed/ai-14all/releases/download/v1.3.0/ai-14all-1.3.0-x64-Setup.exe) — unsigned; SmartScreen may warn on first run → **More info → Run anyway**.
